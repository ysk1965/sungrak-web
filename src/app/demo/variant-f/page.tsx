...
export default function VariantFPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <section ref={heroRef} className="relative h-[55vh] mt-16 md:mt-20 overflow-hidden">
      ...
      <Section background="white" padding="lg" className="-mt-12 relative z-20">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {quickMenus.map((menu, i) => (
            ...
            >
              <Link href={menu.href}>
                <Card className="h-full hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-none shadow-lg group overflow-hidden">
                  <CardContent className="p-5 text-center relative">
                    {/* Hover Background */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${menu.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                    />

                    <div className="relative z-10">
                      <motion.div
                        whileHover={{ scale: 1.1, rotate: 5 }}
                        className={`w-14 h-14 ${menu.color} rounded-xl flex items-center justify-center mx-auto mb-3 shadow-lg group-hover:bg-white/20 group-hover:shadow-none transition-all`}
                      >
                        <menu.icon
                      ...
                      <h3 className="font-bold text-neutral-900 mb-1 group-hover:text-white transition-colors">
                        {menu.label}
                      </h3>
      ...
      {/* Info Bar - Enhanced */}
      <section className="bg-neutral-900 text-white py-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-primary-900/20 via-transparent to-primary-900/20" />
        <Container className="relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: Clock, label: "주일 예배", value: "7:00 / 9:30 / 11:30", link: "/worship" },
              { icon: MapPin, label: "오시는 길", value: "서울 구로구 신도림로", link: "/about#location" },
              {
                icon: Youtube,
                label: "YouTube",
                value: "성락교회 채널 →",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/about">
                <Button className="group shadow-lg shadow-primary-500/25">
                  자세히 보기
                  <ArrowRight
                    size={16}
                    className="group-hover:translate-x-1 transition-transform"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 text-white">
            ...
            >
              <Link href="/newcomer">
                <Button
                  size="lg"
                  className="bg-white text-primary-600 hover:bg-white/90 shadow-xl group h-14 px-8"
                >
                  새가족 안내
                  <ArrowRight
                    size={18}
