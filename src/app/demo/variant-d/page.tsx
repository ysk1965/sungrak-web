...
export default function VariantDPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section ref={heroRef} className="relative h-[80vh] mt-16 md:mt-20 overflow-hidden">
      ...
      <section className="bg-neutral-900 text-white py-5 relative overflow-hidden">
        ...
        <Container className="relative z-10">
          <div className="flex flex-wrap justify-center md:justify-between items-center gap-6 text-sm">
            {[
              { icon: Clock, label: "예배시간", value: "주일 7:00 / 9:30 / 11:30" },
              { icon: MapPin, label: "위치", value: "서울시 구로구 신도림로 56-24" },
      ...
      <Section background="white" padding="xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="relative pl-6 border-l-4 border-primary-500 mb-6">
              <Quote
                size={24}
      ...
      <Section background="gray" padding="lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { name: "주일 1부 예배", time: "오전 7:00", place: "대예배실", color: "from-blue-500 to-blue-600" },
            { name: "주일 2부 예배", time: "오전 9:30", place: "대예배실", color: "from-emerald-500 to-emerald-600" },
            { name: "주일 3부 예배", time: "오전 11:30", place: "대예배실", color: "from-violet-500 to-violet-600" },
            { name: "수요예배", time: "오후 7:30", place: "대예배실", color: "from-amber-500 to-amber-600" },
          ].map((item, i) => (
            <motion.div
              key={item.name}
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <Card className="text-center hover:shadow-xl transition-all duration-300 overflow-hidden group border-0 shadow-md">
                <CardContent className="p-6 relative">
                  ...
                  <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-neutral-100 flex items-center justify-center group-hover:scale-110 transition-transform">
                    <Calendar className="text-primary-500" size={26} />
                  </div>
                  <h3 className="font-bold text-neutral-900 mb-2">{item.name}</h3>
                  <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-amber-500 mb-1">
                    {item.time}
                  </p>
            ...
            <div className="max-w-2xl">
              ...
              >
                <Link href="/newcomer">
                  <Button
                    size="lg"
                    className="bg-white text-primary-600 hover:bg-white/90 shadow-lg group"
                  >
                    새가족 안내
                    <ArrowRight
                      size={18}
