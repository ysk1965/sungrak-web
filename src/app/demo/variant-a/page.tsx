...
import { Play, ArrowRight, ChevronDown, Clock, MapPin, Youtube, ExternalLink } from "lucide-react";
...
import { initialSermons, initialNotices, initialWorships } from "@/mocks/data/initial";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section ref={heroRef} className="relative h-screen overflow-hidden">
        ...
        >
          ...
          >
            <Button
              size="lg"
              className="bg-primary-500 hover:bg-primary-600 text-white group relative overflow-hidden"
            >
      ...
      <Section background="white" padding="xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <Link
              href="/sermons"
              className="inline-flex items-center gap-2 text-primary-500 hover:text-primary-600 font-medium mt-4 group"
            >
              전체 설교 보기
      ...
      <Section background="gray" padding="xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <Badge className="mb-4 bg-primary-100 text-primary-700 hover:bg-primary-100">About Us</Badge>
            ...
            >
              <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-neutral-200 hover:border-primary-200 overflow-hidden">
                <CardContent className="p-6 text-center relative">
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary-400 to-primary-600 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left" />
                  <Clock className="mx-auto text-primary-500 mb-3" size={28} />
                  <h3 className="font-bold text-neutral-900 mb-1">{worship.name}</h3>
      ...
      <Section background="gray" padding="lg">
        <SectionHeader title="교회 소식" subtitle="성락교회의 소식을 전합니다" />
        ...
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { icon: MapPin, label: "오시는 길", href: "/about#location", color: "text-green-500" },
              { icon: Clock, label: "예배시간", href: "/worship", color: "text-blue-500" },
              { icon: ExternalLink, label: "문의하기", href: "/contact", color: "text-purple-500" },
            ].map((item, i) => (
              <motion.a
                key={item.label}
                href={item.href}
                ...
                className="flex items-center justify-center gap-3 p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors text-white"
              >
      ...
      <Link
        href="/"
        className="fixed bottom-6 right-6 z-50 bg-neutral-900 text-white px-4 py-2 rounded-full shadow-lg hover:bg-neutral-800 transition-colors text-sm font-medium"
      >
        ← 시안 선택
      </Link>
    </div>
